...
| Box          | Single-child container                        |
| VStack       | Vertical stack layout                         |
| HStack       | Horizontal stack layout                       |
| Icon         | Lucide icon                                   |

See the [Node Reference](/nodes) for details.

## Auto-Fit

When content exceeds the slide height, pom automatically adjusts it to fit (enabled by default).
