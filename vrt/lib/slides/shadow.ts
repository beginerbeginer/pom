...
<VStack w="100%" h="max" padding="48" gap="20" alignItems="stretch" backgroundColor="${palette.background}">
  ...
  <HStack gap="24" alignItems="start">
    <Shape shapeType="ellipse" w="150" h="100" fill='{"color":"${palette.lightBlue}"}' shadow='{"type":"outer","color":"000000","blur":6,"offset":3,"angle":315,"opacity":0.3}' fontSize="12" color="${palette.charcoal}">Ellipse shadow</Shape>
    <Shape shapeType="roundRect" w="150" h="100" fill='{"color":"${palette.lightBlue}"}' shadow='{"type":"outer","color":"${palette.navy}","blur":10,"offset":5,"angle":270,"opacity":0.5}' fontSize="12" color="${palette.charcoal}">RoundRect shadow</Shape>
  </HStack>
  <!-- Image with shadow -->
  <HStack gap="24" alignItems="start">
    <Box w="180" h="120">
