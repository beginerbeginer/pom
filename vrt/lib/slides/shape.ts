...
<VStack w="100%" h="max" padding="48" gap="20" alignItems="stretch" backgroundColor="${palette.background}">
  ...
  <Box padding="16" backgroundColor="FFFFFF" border='{"color":"${palette.border}","width":1}'>
    <VStack gap="12">
      ...
      <HStack gap="24" alignItems="center">
        <Shape shapeType="ellipse" w="80" h="80" fontSize="14" fill='{"color":"${palette.lightBlue}"}' line='{"color":"${palette.blue}","width":2}'>Circle</Shape>
  ...
  <Box padding="16" backgroundColor="FFFFFF" border='{"color":"${palette.border}","width":1}'>
    <VStack gap="12">
      ...
      <HStack gap="24" alignItems="center">
        <Shape shapeType="rect" w="140" h="50" fontSize="14" fontFamily="Arial" fill='{"color":"${palette.lightBlue}"}' line='{"color":"${palette.blue}","width":1}'>Arial Font</Shape>
        <Shape shapeType="rect" w="140" h="80" fontSize="14" lineHeight="2.0" fill='{"color":"${palette.lightBlue}"}' line='{"color":"${palette.blue}","width":1}'>Line 1\nLine 2\nLine 3</Shape>
      </HStack>
    </VStack>
  </Box>
</VStack>
