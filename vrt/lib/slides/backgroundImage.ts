...
<VStack w="100%" h="max" padding="48" gap="20" alignItems="stretch" backgroundColor="${palette.background}">
  ...
  <Box padding="16" backgroundColor="FFFFFF" border.color="${palette.border}" border.width="1">
    <VStack gap="12">
      ...
      <HStack gap="16">
        <!-- cover モード -->
        <Box w="280" h="180" backgroundImage.src="https://raw.githubusercontent.com/hirokisakabe/pom/main/sample_images/sample_0.png" backgroundImage.sizing="cover" border.color="${palette.border}" border.width="2">
          <Text fontSize="16" color="FFFFFF" bold="true">cover</Text>
        </Box>
        <!-- contain モード -->
        <Box w="280" h="180" backgroundImage.src="https://raw.githubusercontent.com/hirokisakabe/pom/main/sample_images/sample_0.png" backgroundImage.sizing="contain" backgroundColor="333333" border.color="${palette.border}" border.width="2">
          <Text fontSize="16" color="FFFFFF" bold="true">contain (with backgroundColor)</Text>
        </Box>
        <!-- デフォルト（cover） -->
        <Box w="280" h="180" backgroundImage.src="https://raw.githubusercontent.com/hirokisakabe/pom/main/sample_images/sample_1.png" border.color="${palette.border}" border.width="2">
          <Text fontSize="16" color="FFFFFF" bold="true">default (cover)</Text>
        </Box>
      </HStack>
    </VStack>
  </Box>
