...
<VStack w="100%" h="max" padding="48" gap="12" alignItems="stretch" backgroundColor="${palette.background}">
  ...
  <HStack gap="12" alignItems="stretch">
    <VStack w="33%" padding="8" backgroundColor="FFFFFF" border='{"color":"${palette.border}","width":1}' gap="4">
    ...
    <VStack w="34%" padding="8" backgroundColor="FFFFFF" border='{"color":"${palette.border}","width":1}' gap="4">
  ...
  <HStack gap="12" alignItems="stretch">
    <VStack w="25%" padding="8" backgroundColor="FFFFFF" border='{"color":"${palette.border}","width":1}' gap="4">
    ...
    <VStack w="40%" padding="8" backgroundColor="FFFFFF" border='{"color":"${palette.border}","width":1}' gap="4">
    ...
    <VStack w="35%" padding="8" backgroundColor="FFFFFF" border='{"color":"${palette.border}","width":1}' gap="4">
