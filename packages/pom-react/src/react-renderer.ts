...
// JSX の <VStack> 等を React.createElement の文字列タグに委譲することで
// pomReconciler が createInstance("VStack", ...) を受け取れるようにする。
// 文字列 children → text prop 昇格は static-reconciler.ts の shouldSetTextContent で担う。
